...
test:
	...
	go test ./...
	@echo "Running database, lease and cronjob tests against postgres..."
	GST_TEST_DATABASE=postgres go test -count=1 ./database/... ./internal/lease/... ./cronjob/...
	@echo "Running database, lease and cronjob tests against sqlite..."
	GST_TEST_DATABASE=sqlite go test -count=1 ./database/... ./internal/lease/... ./cronjob/...
...
testv:
	...
	go test -v ./...
	@echo "Running database, lease and cronjob tests against postgres with verbose output..."
	GST_TEST_DATABASE=postgres go test -count=1 -v ./database/... ./internal/lease/... ./cronjob/...
	@echo "Running database, lease and cronjob tests against sqlite with verbose output..."
	GST_TEST_DATABASE=sqlite go test -count=1 -v ./database/... ./internal/lease/... ./cronjob/...

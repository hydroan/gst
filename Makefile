...
test:
	...
	GST_TEST_DATABASE=postgres go test -count=1 ./database/...
	@echo "Running database tests against sqlite..."
	GST_TEST_DATABASE=sqlite go test -count=1 ./database/...
...
testv:
	...
	GST_TEST_DATABASE=postgres go test -count=1 -v ./database/...
	@echo "Running database tests against sqlite with verbose output..."
	GST_TEST_DATABASE=sqlite go test -count=1 -v ./database/...

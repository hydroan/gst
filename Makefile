...
DIALECT_PACKAGES := ./database/... ./internal/lease/... ./cronjob/... ./leader/...
...
test:
	...
	GST_TEST_DATABASE=postgres go test -count=1 $(DIALECT_PACKAGES)
...
testv:
	...
	GST_TEST_DATABASE=postgres go test -count=1 -v $(DIALECT_PACKAGES)

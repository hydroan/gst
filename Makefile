...
# BUG-8: the postgres pass stays disabled until model.Base.ID drops its
# char(36) column type -- postgres blank-pads short ids on read, which fails
# most of the suite. Re-enable it here once that fix lands.

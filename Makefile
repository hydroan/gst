...
test:
	...
	go test ./...
	@echo "Running database and lease tests against postgres..."
	GST_TEST_DATABASE=postgres go test -count=1 ./database/... ./internal/lease/...
	@echo "Running database and lease tests against sqlite..."
	GST_TEST_DATABASE=sqlite go test -count=1 ./database/... ./internal/lease/...
...
testv:
	...
	go test -v ./...
	@echo "Running database and lease tests against postgres with verbose output..."
	GST_TEST_DATABASE=postgres go test -count=1 -v ./database/... ./internal/lease/...
	@echo "Running database and lease tests against sqlite with verbose output..."
	GST_TEST_DATABASE=sqlite go test -count=1 -v ./database/... ./internal/lease/...

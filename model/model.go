...
type (
	...
	// Index declares one custom index on a model's table. A model opts in by
	// implementing the optional Indexes() []model.Index method, which covers
	// index shapes gorm struct tags cannot express, such as indexes on the
	// embedded Base columns. Index names are always generated by the framework.

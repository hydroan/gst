...
// limiterCache is the process-wide limiter store. The cache backends carry
// built-in defaults, so construction is pure and safe at package init.
var limiterCache = cache.Cache[*rate.Limiter]()

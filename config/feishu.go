...
const (
	...
	FEISHU_TLS_ENABLED          = "FEISHU_TLS_ENABLED"          //nolint:staticcheck
	...
	FEISHU_ENABLED = "FEISHU_ENABLED" //nolint:staticcheck
)
...
func (*Feishu) setDefault() {
	...
	cv.SetDefault("feishu.tls_enabled", false)
	...
	cv.SetDefault("feishu.enabled", false)
}

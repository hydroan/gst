...
const (
	...
	SCYLLA_CONSISTENCY     = "SCYLLA_CONSISTENCY"
	SCYLLA_NUM_CONNS       = "SCYLLA_NUM_CONNS"
	SCYLLA_CONNECT_TIMEOUT = "SCYLLA_CONNECT_TIMEOUT"
	SCYLLA_TIMEOUT         = "SCYLLA_TIMEOUT"
	SCYLLA_PAGE_SIZE       = "SCYLLA_PAGE_SIZE"

	SCYLLA_RETRY_POLICY       = "SCYLLA_RETRY_POLICY"
	SCYLLA_RETRY_NUM_RETRIES  = "SCYLLA_RETRY_NUM_RETRIES"
	SCYLLA_RETRY_MIN_INTERVAL = "SCYLLA_RETRY_MIN_INTERVAL"
	SCYLLA_RETRY_MAX_INTERVAL = "SCYLLA_RETRY_MAX_INTERVAL"

	SCYLLA_RECONNECT_POLICY            = "SCYLLA_RECONNECT_POLICY"
	SCYLLA_RECONNECT_MAX_RETRIES       = "SCYLLA_RECONNECT_MAX_RETRIES"
	SCYLLA_RECONNECT_INITIAL_INTERVAL  = "SCYLLA_RECONNECT_INITIAL_INTERVAL"
	SCYLLA_RECONNECT_MAX_INTERVAL      = "SCYLLA_RECONNECT_MAX_INTERVAL"
	SCYLLA_RECONNECT_CONSTANT_INTERVAL = "SCYLLA_RECONNECT_CONSTANT_INTERVAL"

	SCYLLA_TRACING_ENABLED      = "SCYLLA_TRACING_ENABLED"
	SCYLLA_TLS_ENABLED          = "SCYLLA_TLS_ENABLED"
	SCYLLA_CERT_FILE            = "SCYLLA_CERT_FILE"
	SCYLLA_KEY_FILE             = "SCYLLA_KEY_FILE"
	SCYLLA_CA_FILE              = "SCYLLA_CA_FILE"
	SCYLLA_INSECURE_SKIP_VERIFY = "SCYLLA_INSECURE_SKIP_VERIFY"

	SCYLLA_ENABLED = "SCYLLA_ENABLED"
)

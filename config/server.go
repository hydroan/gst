...
const (
	...
	SERVER_SHUTDOWN_DELAY = "SERVER_SHUTDOWN_DELAY"
	...
	SERVER_CIRCUIT_BREAKER_ENABLED      = "SERVER_CIRCUIT_BREAKER_ENABLED"

	SERVER_CIRCULAR_BUFFER_SIZE_OPERATION_LOG = "SERVER_CIRCULAR_BUFFER_SIZE_OPERATION_LOG"
)

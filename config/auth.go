...
const (
	...
	AUTH_NONE_EXPIRE_PASSWORD          = "AUTH_NONE_EXPIRE_PASSWORD"
...
type Auth struct {
	...
	NoneExpirePassword         string        `json:"none_expire_password" mapstructure:"none_expire_password" ini:"none_expire_password" yaml:"none_expire_password"`
...
func (*Auth) setDefault(v *viper.Viper) {
	...
	v.SetDefault("auth.none_expire_password", noneExpirePass)

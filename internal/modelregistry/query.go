...
// its own fields as query filters through schema tags, while Query enables
// framework controls such as pagination, fuzzy matching, sorting, expansion,
// cursor pagination, cache control, and total-count suppression.
//
...
// QueryEnabled marks models that opt in to framework query parameters.

...
`,
		...
		},
		{
			...
			stmts:       []ast.Stmt{StmtServiceRegister("user", consts.PHASE_CREATE, "users")},
			want: `// Code generated by gst; DO NOT EDIT.
package service
...
`,
		...
		},
		{
			...
			modelImport: []string{"helloworld/model"},
			pkgName:     "service",
			stmts:       []ast.Stmt{StmtServiceRegister("user", consts.PHASE_CREATE, "users"), StmtServiceRegister("group", consts.PHASE_UPDATE, "groups/:id")},
			want: `// Code generated by gst; DO NOT EDIT.
package service

...
5. 批次边界不许顺手扩大，也不许沉默跳过：修 bug、重构、加能力途中发现的任何计划外问题（真 bug、坏味道、过时或错误的注释、缺失的测试、性能与安全隐患、可优化点），当场记下来，在本批汇报里给出位置、现象、影响，不另编批次；我批准后在当前批次结束后接着处理。我没答复前不要动它，也不要只自己知道不报。

...
除一两行小修外，修 bug、重构、加能力一律分批交付，我批哪批你做哪批：
...
5. 批次边界不许顺手扩大，也不许沉默跳过：修 bug、重构、加能力途中发现的任何计划外问题（真 bug、坏味道、过时或错误的注释、缺失的测试、性能与安全隐患、可优化点），当场记下来，在本批汇报里给出位置、现象、影响，以及「单独成批（排在第几批）/ 建议并入哪一批 / 建议不做」的判断，由我决定要不要进批次。我没答复前不要动它，也不要只自己知道不报。

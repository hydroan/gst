...
4. 出现bug时，先编写能重现该bug的测试，再修复直到测试通过
5. 每次我纠正你时，反思你做错了什么，并制定永不再犯的计划
6. 如果需求没有完全理解，请继续向我提问，直到完全清楚需求了才开始写代码！

### 分批交付与 review

改动要让我能逐批 review，所以除一两行的小修外，动手前先给「批次总览」，我批哪批你做哪批。修 bug、重构、加能力一律适用。

1. 先给总览再动手：每批列出目标、涉及文件、有无行为变更、验收命令、review 关注点、预估 diff 大小，并按推荐的执行顺序编号。我可能只批其中几批，不要默认全批通过。
...
4. 一批做完停下汇报，等我明确说「继续」再做下一批；批准某一批不等于批准后续批次，方案因我的答复变了就重新呈现再等批准。
